...
def build_generation_prompt(
    ...
    Combines the client profile data with the IPS template reference
    into a single prompt for the generation agent.
    ...
    """
    return f"""请根据以下客户画像数据，参照 IPS 结构模板，生成一份完整的投资政策声明书。
